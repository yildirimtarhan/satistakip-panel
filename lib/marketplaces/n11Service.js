    ...
    skus: [
      {
        ...
        ...(product.images?.length
          ...
          : {}),
        // Marka — N11 REST'te SKU'da doğrudan brandId alanı (attributes değil)
        ...(product.marketplaceSettings?.n11?.brandId
          ...
          : {}),
        // Ürün güvenliği Marka attribute'u (1000001 = "Marka (Ürün Güvenliği)", isCustomValue=true)
        ...(product.marketplaceSettings?.n11?.brandName || product.n11BrandName
          ? {
              attributes: [
                { attributeId: 1000001, customAttributeValue: product.marketplaceSettings?.n11?.brandName || product.n11BrandName },
                ...(product.n11Attributes || []),
              ],
            }
          : product.n11Attributes?.length
          ? { attributes: product.n11Attributes }
          : {}),
      },
    ],
  };
