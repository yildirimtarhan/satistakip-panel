 ...
 * @param {string} [data.senderName] - Gönderen / pazaryeri mağaza adı (API Ayarları)
 * @param {string} [data.firmaAdi] - Firma adı (Firma Ayarları)
 */
...
<body>
  ...
  <div class="label">
    ...
    <div class="footer">${firmaAdi ? `Firma: ${firmaAdi} | ` : ""}Mağaza: ${senderName} | Hepsiburada siparişi</div>
  </div>
</body>
</html>`;
}
