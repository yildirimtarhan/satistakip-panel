/**
 * e-Arşiv zarf durum sorgulama
 * POST /EArchiveInvoice/GetEnvelopeStatus
 */
import { connectToDatabase } from "@/lib/mongodb";
import jwt from "jsonwebtoken";
import { earsivGetEnvelopeStatus } from "@/lib/taxten/taxtenClient";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error("[Taxten] E-Arşiv GetEnvelopeStatus:", err.response?.data || err.message);
